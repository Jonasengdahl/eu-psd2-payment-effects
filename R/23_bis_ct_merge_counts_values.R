# scripts/23_bis_ct_merge_counts_values.R
# =========================================
# Merge BIS credit transfer sent counts + values (US + Canada, annual)
# Objective:
...
#
# Inputs:
#   data/intermediate/bis/credit_transfers/ct_counts_country_year_intermediate.{csv|rds}
#   data/intermediate/bis/credit_transfers/ct_values_country_year_intermediate.{csv|rds}
#
# Outputs:
#   data/processed/bis/credit_transfers/ct_country_year.csv
#   data/processed/bis/credit_transfers/ct_country_year.rds
#
# Diagnostics:
#   outputs/tables/bis_ct_merge_key_coverage.csv
#   outputs/tables/bis_ct_merge_missingness_by_country.csv
#   outputs/tables/bis_ct_merge_country_coverage.csv
#   outputs/tables/bis_ct_merge_summary.txt
#   outputs/logs/23_bis_ct_merge_counts_values_log.txt
# =========================================
...
# 0. Logging
# =========================================
log_file <- here::here("outputs/logs", "23_bis_ct_merge_counts_values_log.txt")
...
cat("\n=========================================\n")
cat("23_bis_ct_merge_counts_values.R — START\n")
...
# 1. Paths
# =========================================
in_dir <- here::here("data/intermediate/bis/credit_transfers")
...
out_dir <- here::here("data/processed/bis/credit_transfers")
...
key_cov_csv <- file.path(diag_dir, "bis_ct_merge_key_coverage.csv")
miss_country_csv <- file.path(diag_dir, "bis_ct_merge_missingness_by_country.csv")
coverage_year_csv <- file.path(diag_dir, "bis_ct_merge_country_coverage.csv")
summary_txt <- file.path(diag_dir, "bis_ct_merge_summary.txt")
...
summary_lines <- c(
  "BIS CPMI Cashless (Credit transfers) — Merge Summary (US + Canada)",
...
# =========================================
cat("\n=========================================\n")
cat("23_bis_ct_merge_counts_values.R — END\n")
cat("Timestamp: ", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), "\n")
cat("=========================================\n\n")
