# scripts/29b_bis_card_merge_counts_values_with_CH.R
# =========================================
# Merge BIS card payments counts + values (US + Canada + Switzerland, annual)
...
#   data/intermediate/bis_with_CH/card_payments/cp_counts_country_year_intermediate_with_CH.{csv|rds}
#   data/intermediate/bis_with_CH/card_payments/cp_values_country_year_intermediate_with_CH.{csv|rds}
#
# Outputs (ROBUSTNESS PATH: includes CH):
#   data/processed/bis_with_CH/card_payments/cp_country_year_with_CH.csv
#   data/processed/bis_with_CH/card_payments/cp_country_year_with_CH.rds
#   outputs/tables/bis_cp_merge_key_coverage_with_CH.csv
#   outputs/tables/bis_cp_merge_missingness_by_country_with_CH.csv
#   outputs/tables/bis_cp_merge_country_coverage_with_CH.csv
#   outputs/tables/bis_cp_merge_summary_with_CH.txt
#   outputs/logs/29b_bis_card_merge_counts_values_with_CH_log.txt
# =========================================
...
log_file <- here::here("outputs/logs", "29b_bis_card_merge_counts_values_with_CH_log.txt")
...
cat("\n=========================================\n")
cat("29b_bis_card_merge_counts_values_with_CH.R — START\n")
...
# -----------------------------
in_dir <- here::here("data/intermediate/bis_with_CH/card_payments")

counts_rds <- file.path(in_dir, "cp_counts_country_year_intermediate_with_CH.rds")
counts_csv <- file.path(in_dir, "cp_counts_country_year_intermediate_with_CH.csv")

values_rds <- file.path(in_dir, "cp_values_country_year_intermediate_with_CH.rds")
values_csv <- file.path(in_dir, "cp_values_country_year_intermediate_with_CH.csv")

out_dir <- here::here("data/processed/bis_with_CH/card_payments")
dir.create(out_dir, recursive = TRUE, showWarnings = FALSE)

out_csv <- file.path(out_dir, "cp_country_year_with_CH.csv")
out_rds <- file.path(out_dir, "cp_country_year_with_CH.rds")

diag_dir <- here::here("outputs/tables")
dir.create(diag_dir, recursive = TRUE, showWarnings = FALSE)

key_cov_csv <- file.path(diag_dir, "bis_cp_merge_key_coverage_with_CH.csv")
miss_country_csv <- file.path(diag_dir, "bis_cp_merge_missingness_by_country_with_CH.csv")
coverage_year_csv <- file.path(diag_dir, "bis_cp_merge_country_coverage_with_CH.csv")
summary_txt <- file.path(diag_dir, "bis_cp_merge_summary_with_CH.txt")
...
summary_lines <- c(
  "BIS CPMI Cashless (Card payments, Annual) — Merge Summary (US + Canada + Switzerland) [with_CH]",
...
# -----------------------------
cat("\n=========================================\n")
cat("29b_bis_card_merge_counts_values_with_CH.R — END\n")
cat("Timestamp: ", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), "\n")
cat("=========================================\n\n")
